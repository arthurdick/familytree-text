...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const cy = cytoscape({
        ...
        style: [
            ...
            },
            {
                ...
                style: { label: "data(label)", "font-size": "6px", color: "#20c997" }
            },
    ...
    worker.onmessage = (e) => {
        ...
        if (type === "SUCCESS") {
            ...
            if (hasErrors || hasWarnings) {
                ...
                if (errors)
                    errors.forEach((err) => errorBox.appendChild(createMessageRow(err, "ERROR")));
                if (warnings)
                    warnings.forEach((warn) =>
                        errorBox.appendChild(createMessageRow(warn, "WARNING"))
                    );
            } else {
    ...
    btnNew.addEventListener("click", () => {
        ...
        if (
            confirm("Are you sure you want to clear the editor? This will erase unsaved changes.")
        ) {
            editor.value = DEFAULT_TEMPLATE;
